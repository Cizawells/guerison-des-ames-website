...
const about_content: ContentData = {
  ...
  title: (
    <>
      Welcome To Our Charity <span>Organization</span>
    </>
  ),
  desc: (
    <>
      There are many variations of passages of available but the majority have
      suffered alteration in some form, by injected humou ndomised words even
      slightly believable Making this the first true.
    </>
  ),
  list: [
          ...
          <div className="col-xl-6">
            <div className="about-us-image-part mb-65 rel">
              ...
              <div
                ...
                style={{
                  backgroundImage: `url(${urlFor(aboutusData.experienceImage).url()})`,
                }}
              >
