...
const HeaderOne = ({ style_1, style_2 }: any) => {
  ...
  return (
    <>
      ...
      <nav
        className={`navbar navbar-area navbar-expand-lg ${style_1 ? "navbar--two" : "py-30 navbar--one"} ${style_2 ? "navbar--three" : ""} ${sticky ? "sticky-active" : ""}`}
      >
        <div className="container nav-container navbar-bg">
          ...
          <div className="logo">
            <Link href="/">
              <Image src={logo} alt="img" style={{ height: "30px" }} />
            </Link>
          </div>
