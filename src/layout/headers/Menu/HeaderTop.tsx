         ...
         <div className="container">
            <div className={`navtop-inner ${style ? "bgc-gray" : ""}`}>
               <ul className="topbar-left">
                  {style ?
                     <>
                        <li><b>Shalom - <Link href="callto:333-444555">+25776720000</Link></b></li>
               ...
               <ul className="topbar-right">
                  <li className="social-area">
                     ...
                     <Link  legacyBehavior href="https://www.facebook.com/guerisondesamesnyakabigaSiege/?locale=fr_FR" passHref>
